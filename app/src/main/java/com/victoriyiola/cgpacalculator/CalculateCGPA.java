...
public class CalculateCGPA extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.calculate_cgpa);
        ...
        // Get noOfSemesters from Homepage
    ...
    private void initializeVars() {
        ...
        Button calculate = (Button) findViewById(R.id.bCalculate);
    ...
    private void showLayout() {
        ...
        switch (noOfSemesters) {
            case 1: /* 100 1st Semester */
                visibilityGone(levels[1]); visibilityGone(semesters[1]);
                levelSemester[0] = 100; levelSemester[1] = 1;
            case 2: /* 100 2nd Semester */
                visibilityGone(levels[1]); visibilityGone(semesters[2]);
                levelSemester[0] = 100; levelSemester[1] = 2;
            case 3: /* 200 1st Semester */
                visibilityGone(levels[2]); visibilityGone(semesters[3]);
                levelSemester[0] = 200; levelSemester[1] = 1;
            case 4: /* 200 2nd Semester */
                visibilityGone(levels[2]); visibilityGone(semesters[4]);
                levelSemester[0] = 200; levelSemester[1] = 2;
            case 5: /* 300 1st Semester */
                visibilityGone(levels[3]); visibilityGone(semesters[5]);
                levelSemester[0] = 300; levelSemester[1] = 1;
            case 6: /* 300 2nd Semester */
                visibilityGone(levels[3]); visibilityGone(semesters[6]);
                levelSemester[0] = 300; levelSemester[1] = 2;
            case 7: /* 400 1st Semester */
                visibilityGone(levels[4]); visibilityGone(semesters[7]);
                levelSemester[0] = 400; levelSemester[1] = 1;
            case 8: /* 400 2nd Semester */
                visibilityGone(levels[4]); visibilityGone(semesters[8]);
                levelSemester[0] = 400; levelSemester[1] = 2;
            case 9: /* 500 1st Semester */
                visibilityGone(levels[5]); visibilityGone(semesters[9]);
                levelSemester[0] = 500; levelSemester[1] = 1;
            case 10: /* 500 2nd Semester */
                visibilityGone(levels[5]); visibilityGone(semesters[10]);
                levelSemester[0] = 500; levelSemester[1] = 2;
            case 11: /* 600 1st Semester */
                visibilityGone(levels[6]); visibilityGone(semesters[11]);
                levelSemester[0] = 600; levelSemester[1] = 1;
            case 12: /* 600 2nd Semester */
                visibilityGone(levels[6]); visibilityGone(semesters[12]);
                levelSemester[0] = 600; levelSemester[1] = 2;
            case 13: /* 700 1st Semester */
                visibilityGone(semesters[13]);
                levelSemester[0] = 700; levelSemester[1] = 1;
            case 14: /* 700 2nd Semester */
                levelSemester[0] = 700; levelSemester[1] = 2;
        ...
        switch (view.getId()) {
            case R.id.bCalculate:
                ...
                for (int i = 0; i < noOfSemesters; i++) {
                    ...
                    if (sgpa.isEmpty()) {
                        Message.show(this, "Invalid Grade Input", "The " + dHelp + " field is empty!");
                        return;
                    }
                    ...
                    try {
                        ...
                        if (gpa > 5.00) {
                            Message.show(this, "Invalid Grade Input", validGradeErrorMessage);
                            return;
                        }
    ...
    private class LoadInfoInDB extends AsyncTask<String, Integer, String> {
